...
type Key_FortanixDsmKey struct {
	FortanixDsmKey *FortanixDsmKey `protobuf:"bytes,7,opt,name=fortanix_dsm_key,json=fortanixDsmKey,proto3,oneof"`
}
...
func (*Key_FortanixDsmKey) isKey_KeyType() {}
...
func (m *Key) GetFortanixDsmKey() *FortanixDsmKey {
	if x, ok := m.GetKeyType().(*Key_FortanixDsmKey); ok {
		return x.FortanixDsmKey
	}
	return nil
}
...
func (m *FortanixDsmKey) Reset()         { *m = FortanixDsmKey{} }
func (m *FortanixDsmKey) String() string { return proto.CompactTextString(m) }
func (*FortanixDsmKey) ProtoMessage()    {}
func (*FortanixDsmKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c1e2c407c293790, []int{7}
}

func (m *FortanixDsmKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FortanixDsmKey.Unmarshal(m, b)
}
func (m *FortanixDsmKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FortanixDsmKey.Marshal(b, m, deterministic)
}
func (m *FortanixDsmKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FortanixDsmKey.Merge(m, src)
}
func (m *FortanixDsmKey) XXX_Size() int {
	return xxx_messageInfo_FortanixDsmKey.Size(m)
}
func (m *FortanixDsmKey) XXX_DiscardUnknown() {
	xxx_messageInfo_FortanixDsmKey.DiscardUnknown(m)
}

var xxx_messageInfo_FortanixDsmKey proto.InternalMessageInfo

func (m *FortanixDsmKey) GetUuid() string {
	if m != nil {
		return m.Uuid
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*FortanixDsmKey)(nil), "FortanixDsmKey")
...
var fileDescriptor_8c1e2c407c293790 = []byte{
	...
	,
}
